...
interface LoginMenuSessionUserProps {
	isOpenMenuSessionUser: boolean;
}
...
export const OpenLinksButton = styled.button<NavbarProps>`
	display: none;
	justify-content: center;
	align-items: center;
	background: none;
...
export const LoginMenuSessionUser = styled.nav<LoginMenuSessionUserProps>`
	display: flex;
	justify-content: center;
	align-items: center;
	gap: 10px;
