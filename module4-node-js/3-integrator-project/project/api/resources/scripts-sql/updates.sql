UPDATE recipes
SET ingredients = '400g de espagueti.
					2 huevos.
					150g de queso curado.
					120g de bacon o panceta.
					Sal y pimienta.
					Un pequeño chorrito de aceite de oliva.',
	instructions = 'Ponemos un puñadito de sal (generoso) en abundante agua hirviendo. Después añadimos los espagueti y los dejamos cocer aquí alrededor de 10 minutos. Conviene removerlos con frecuencia sobre todo al principio de la cocción, para que no se peguen.
