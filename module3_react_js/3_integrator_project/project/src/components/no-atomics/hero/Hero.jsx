...
import { HeroContainerStyled, HeroFormStyled, HeroSearchBarStyled, IconWrapperStyled, MessageNotRecipes } from "./HeroStyles";
	...
	return (
		<>
			...
			(recipeSection == "Home" && recipesAll.length != 0) ? (
				...
				<MessageNotRecipes>No existen recetas</MessageNotRecipes>
			)}
		</>
	);
};
