...
import { CardsContainerStyled, CardStyled, CardTitleStyled, CardBodyStyled } from "./CardStyles";
	...
	return (
		<CardsContainerStyled>
			...
			<CardStyled>
				...
				<CardBodyStyled>
					<p>It's not easy being drunk all the time. If it were easy, everyone would do it.</p>
				</CardBodyStyled>
			</CardStyled>
			...
			<CardStyled>
				...
				<CardBodyStyled>
					<p>Sometimes there is no happy choice Sam, only one less grievous than the others.</p>
				</CardBodyStyled>
			</CardStyled>
		</CardsContainerStyled>
	);
